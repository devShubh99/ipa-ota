...
## Corpus Check
- 21 files · ~13,686 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 90 nodes · 90 edges · 32 communities detected
- Extraction: 61% EXTRACTED · 39% INFERRED · 0% AMBIGUOUS · INFERRED: 35 edges (avg confidence: 0.84)
...
5. `IPA OTA Installer` - 5 edges
6. `getBuild()` - 4 edges
7. `parseIpa()` - 4 edges
8. `Upload Component` - 4 edges
9. `Register API` - 4 edges
...
- `Cron Cleanup Job` --semantically_similar_to--> `Cron Job`  [INFERRED] [semantically similar]
  README.md → AGENTS.md
- `GET()` --calls--> `getTotalStorageUsed()`  [INFERRED]
  app/dl/[buildId]/route.ts → /Users/shubh/Projects/Personal/ipa-ota/lib/kv.ts
...
Cohesion: 0.22
Nodes (9): decrementStorage(), deleteBuild(), getBuild(), getBuildIdByDeleteToken(), buildPageHtml(), DELETE(), escapeXml(), GET() (+1 more)

### Community 2 - "Community 2"
Cohesion: 0.29
Nodes (6): generateBuildId(), generateDeleteToken(), getTotalStorageUsed(), incrementStorage(), saveBuild(), POST()
...
- **Thin community `Community 7`** (2 nodes): `graphify`, `Graphify-First Development Agent`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 8`** (1 nodes): `writing-skills`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
...
- **Thin community `Community 13`** (1 nodes): `postcss.config.js`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 14`** (1 nodes): `setup.ts`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 15`** (1 nodes): `ipa-parser.test.ts`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 16`** (1 nodes): `kv.test.ts`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 17`** (1 nodes): `api.test.ts`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 18`** (1 nodes): `Vercel Blob Storage`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 19`** (1 nodes): `Vercel KV Database`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 20`** (1 nodes): `brainstorming`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 21`** (1 nodes): `systematic-debugging`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 22`** (1 nodes): `test-driven-development`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 23`** (1 nodes): `caveman`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 24`** (1 nodes): `requesting-code-review`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 25`** (1 nodes): `receiving-code-review`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 26`** (1 nodes): `finishing-a-development-branch`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 27`** (1 nodes): `using-git-worktrees`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 28`** (1 nodes): `dispatching-parallel-agents`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 29`** (1 nodes): `subagent-driven-development`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 30`** (1 nodes): `verification-before-completion`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 31`** (1 nodes): `Decision Node`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
...
- **Are the 5 inferred relationships involving `IPA OTA Installer` (e.g. with `Upload Component` and `Register API`) actually correct?**
  _`IPA OTA Installer` has 5 INFERRED edges - model-reasoned connections that need verification._